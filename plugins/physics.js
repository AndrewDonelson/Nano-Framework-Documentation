...
/** @lends h5c3.components.Joint */
{
	/**
	 * Construct (or acquires) a new component with the options supplied
	 * @param {h5c3.Entity} options.attachTo Entity to attach the joint to
	 * @param {h5c3.Dim} options.offset Dim x, y of the pixel offset the joint is relative to the source entity
	 * @param {h5c3.Dim} options.attachmentOffset Dim x, y of the offset of the joint on the attached entity
	 * @param {Number} options.distance How long the joint is
	 * @param {h5c3.JointType} options.type Type of joint (h5c3.JointType.WELD, h5c3.JointType.REVOLUTE, h5c3.JointType.DISTANCE)
	 ...
	 * @return {h5c3.components.Joint} A configured joint component
	 */
...
/** @lends h5c3.components.Joint.prototype */
{
...
/** @lends h5c3.systems.Physics.prototype */
{
	/** the physics world */
	world:null,
	 ...
	 * @param {h5c3.Dim} options.gravity Level of gravity as a 2D vector (gravity.x, gravity.y)
	 * @param {h5c3.TileMap} options.tileCollisionMap.tileMap A tile map which will be used to construct tile collisions
	...
	init:function (options)
	{
		...
		this.debugDraw.SetSprite(h5c3.device.game.ctx);
	 ...
	 * @param {h5c3.Entity} entity Entity being processed
	 */
	 ...
	 * @param {h5c3.Rect} rect Area to query
	 ...
	 * @param {h5c3.TileMap} tileMap Tile map for all the tiles
	 * @param {Number} collisionGroup Collision group index
	 * @param {Number} collisionCategory Collision category
	 * @param {Number} collisionMask Collision mask
	 */
	 ...
	 * @param {h5c3.BodyType} aType Type of the collision body (h5c3.BodyType.TILE or h5c3.BodyType.ENTITY)
	 * @param {h5c3.BodyType} bType Type of the collision body (h5c3.BodyType.TILE or h5c3.BodyType.ENTITY)
	 * @param {h5c3.Entity} entityA If an entity, a reference to the entity that was the first part of the collision
	 * @param {h5c3.Entity} entityB If an entity, a reference to the entity that was the second part of the collision
...
/** @lends h5c3.components.Physics */
{
	 ...
	 * @param {h5c3.Dim} [options.maxSpeed] Maxium velocity to allow the entity to go (as an x, y vector)
	 * @param {h5c3.Dim} [options.gravity] Gravity override for the entity only (x, y vector)
	 ...
	 * @param {h5c3.CollisionShape} [options.shape] Collision shape default (if shapes array not set)
	 ...
	 * @param {h5c3.Dim} [options.centerOfMass] Where to position the entities centerOfMass (x, y)
	 */
	create:function (options)
	{
		var n = this._super();
...
/** @lends h5c3.components.Physics.prototype */
{
	 ...
	 * @return {h5c3.Dim} Current velocity as a 2d vector
	 */
