...
/** Interface: h5c3.components.Input */
{
	/**
	 * Constructs (or acquires from the pool) an input component.
	 * Parameters:  Array options.states Array of states, e.g. states:['fire',['SPACE','D']];
	 * Parameters:  Array options.actions Array of actions, e.g. actions:['fire',['SPACE','D']];
	 * Parameters:  {h5c3.Entity} [options.target] Optional target entity. If set, actions and states will be set on this,
	 * not the entity that contains the component. It will only be used for spatial positional.
	 * Returns: {h5c3.components.Spatial} A shiny new input component
	 */
...
/** Interface: h5c3.components.Input.prototype */
{
...
/** Interface: h5c3.systems.Input */
{},
/** Interface: h5c3.systems.Input.prototype */
{
	/**
	 ...
	 * Parameters:  String actionName Name of the action
	 * Parameters:  {Event} event Event object that caused the input
	 * Parameters:  {h5c3.Point} pos Position the input occurred
	 * Parameters:  Object uiTarget The target that received the input (spatial of an entity if bound)
	 */
	 ...
	 * Parameters:  {h5c3.Entity} entity Entity testing the active state for
	 * Parameters:  String state The state to test
	 * Returns: Boolean true if the state is presently on
	 */
