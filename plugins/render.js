...
/** @lends h5c3.components.Alpha.prototype */
{
...
/** @lends h5c3.components.Circle */
{
	 ...
	 * @return {h5c3.components.Circle} The new component
	 */
	create:function (options)
	{
		var n = this._super();
...
/** @lends h5c3.components.Circle.prototype */
{
...
/** @lends h5c3.components.Clip.prototype */
{
...
/** @lends h5c3.components.OriginShifter */
{
	/**
...
/** @lends h5c3.components.OriginShifter.prototype */
{
	/** current shift ratio */
	ratio:1,
...
/** @lends h5c3.components.Overlay */
{
	 ...
	 * @param {h5c3.SpriteSheet} options.spriteSheet Sprite sheet to use for the animation
	 ...
	 * @return {h5c3.components.Overlay} An overlay component
	 */
	create: function(options)
	{
		var n = this._super();
...
/** @lends h5c3.components.Overlay.prototype */
{
...
/** @lends h5c3.components.Poly */
{
	 ...
	 * @return {h5c3.components.Poly} The new component
	 */
	create:function (options)
	{
		var n = this._super();
...
/** @lends h5c3.components.Poly.prototype */
{
	/** h5c3.Color representing fill color */
	color:null,
	/** h5c3.Color representing stroke color */
...
/** @lends h5c3.components.Rect */
{
	 ...
	 * @return {h5c3.components.Rect} A rectangle component
	 */
	create:function (options)
	{
		var n = this._super();
...
/** @lends h5c3.components.Rect.prototype */
{
	/** h5c3.Color representing fill color */
	color:null,
	/** h5c3.Color representing stroke color */
...
/** @lends h5c3.components.Spatial */
{
	/**
	 * Constructs (or acquires from the pool) a spatial component configuring it with the given options
	 * @param {h5c3.Point} options.pos Position (containing x, y) to place the entity
	 * @param {h5c3.Dim} options.dim Size (containing x, y) of the entity (x=width, y=height)
	 * @return {h5c3.components.Spatial} A shiney new component
	 */
	create: function(options)
	{
		var n = this._super();
...
/** @lends h5c3.components.Spatial.prototype */
{
	 ...
	 * @return {h5c3.Point} the current position
	 */
	getPos: function()
	{
		return this.pos;
	 ...
	 * @return {h5c3.Dim} Reference to the current h5c3.Dim for this spatial
	 */
	getDim: function()
	{
		return this.dim;
	 ...
	 * @return {h5c3.Point} The unscaled position
	 */
	 ...
	 * @return {h5c3.Dim} The unscaled dimensions
	 */
	 ...
	 * @return {h5c3.Point} A h5c3.Point representing the center of the spatial (cached so you do not need to release it)
	 */
	 ...
	 * @return {h5c3.Rect} on-screen rectangle (cached, so you should not release it). Null if not on a layer.
	 */
...
/** @lends h5c3.components.Sprite */
{
	/**
	 * Constructs (or acquires from the pool) a sprite component.
	 * @param {h5c3.Sprite} options.sprite Sprite object to use
	 * @param {h5c3.Point} options.offset Object containing x, y properties. Offset position of the sprite.
	 * @return {h5c3.components.Sprite} A newly configured sprite component
	 */
	create: function(options)
	{
		var n = this._super();
...
/** @lends h5c3.components.Sprite.prototype */
{
	/** sprite object */
	sprite:null,
...
/** @lends h5c3.components.Text */
{
	 ...
	 * @param {h5c3.Point} options.offset Object containing x, y properties. Offset position of the text.
	 * @return {h5c3.components.Text} A text component
	 */
	create: function(options)
	{
		var n = this._super();
...
/** @lends h5c3.components.Text.prototype */
{
	/** h5c3.Color representing fill color */
	color: null,
	/** h5c3.Color representing stroke color */
...
/** @lends h5c3.systems.Render */
{},
/** @lends h5c3.systems.Render.prototype */
{
	/**
