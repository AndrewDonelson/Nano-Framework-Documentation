...
/** Interface: h5c3.components.Fade */
{
	/**
	 * Constructs (or acquires from the pool) a fade component
	 * Parameters:  Number options.startDelay ms to wait before doing anything
	 * Parameters:  Number options.fadeInTime time to fade in (in ms)
	 * Parameters:  Number options.fadeOutTime time to fade out (in ms)
	 * Parameters:  Number options.holdTime time to hold between fading in and fading out (in ms)
	 * Parameters:  Number options.loops number of loops (0=infinite)
	 * Returns: {h5c3.components.Fade} A configured fade component
	 */
...
/** Interface: h5c3.components.Fade.prototype */
{
...
/** Interface: h5c3.components.Scale */
{
	/**
	 * Constructs (or acquires from the pool) a scale component
	 * Parameters:  Number options.x initial x-axis scale
	 * Parameters:  Number options.y initial y-axis scale
	 * Parameters:  Number options.growX amount to grow x-axis per second (can be negative)
	 * Parameters:  Number options.growY amount to grow y-axis per second (can be negative)
	 * Parameters:  Number options.maxX maximum x-axis scale change
	 * Parameters:  Number options.maxY maximum y-axis scale change
	 * Returns: {h5c3.components.Scale} A configured component
	 */
	create:function (options)
	{
		var n = this._super();
...
/** Interface: h5c3.components.Scale.prototype */
{
...
/** Interface: h5c3.components.Spin */
{
	/**
	 * Constructs (or acquires from the pool) a fade component
	 * Parameters:  Number options.rate rate of spin in degrees per second (default is 15)
	 * Parameters:  Number options.max Amount to spin (optional, default is 0 - unlimited)
	 * Parameters:  Boolean options.clockwise Whether to spin in a clockwise direction (default is true)
	 * Returns: {h5c3.components.Spin} A configured component
	 */
	create:function (options)
	{
		var n = this._super();
...
/** Interface: h5c3.components.Spin.prototype */
{
...
/** Interface: h5c3.systems.Effects */
{
	FadeState:
	{
		NOT_STARTED: 0,
...
/** Interface: h5c3.systems.Effects.prototype */
{
	/**
