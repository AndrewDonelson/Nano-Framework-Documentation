...
/** Interface: h5c3.components.Layout */
{
	/**
	 * Constructs (or acquires from the pool) a layout component
	 * Parameters:  String options.vertical Vertical positioning: 'top', 'center', 'bottom'
	 * Parameters:  String options.horizontal Horizontal positioning: 'left', 'center', 'right'
	 * Parameters:  Object options.margin Margin for the entity (ie. margin.left, right, top, bottom)
	 * Returns: {h5c3.components.Layout} A newly configured layout component
	 */
...
/** Interface: h5c3.components.Layout.prototype */
{
...
/** Interface: h5c3.systems.Layout */
{},
/** Interface: h5c3.systems.Layout.prototype */
{
	 ...
	 * Parameters:  Number options.margin.left Default left margin for all entities
	 * Parameters:  Number options.margin.right Default right margin for all entities
	 * Parameters:  Number options.margin.top Default top margin for all entities
	 * Parameters:  Number options.margin.bottom Default bottom margin for all entities
	 */
	...
	doLayout: function()
	{
		...
		while (next)
		{
			...
			//console.log(' adding: ' + next.obj.toString() + ' to anchor  ' + al);
			next = next.next();
		}
