/** 
 * @preserve H5C3 Framework v0.9.7-RC1-Production
 */
...
window.H5C3 = gamecore.Base('H5C3', {
	 ...
	 */
	LOCATION: 'http://h5c3.i2tmlabs.com/',
	/**
	...
	devMode: false,
	/**
	 * Property: Boolean		rwdMode			
	 * [true|false]
	 * 
	 * True 	- Load Engine Only (No Canvas 2D/3D, ect)
	 * False 	- Load Complete Engine & Framework, Bootstrap full CloudApp
	 */
	rwdMode: true,
	...
	init: function() {
		...
		if("undefined"===typeof H5C3CFG) { 
			...
			//if (H5C3.DISTRO==="Developer"||H5C3.DISTRO==="Production") { this.devMode = true; } else { this.devMode = false; }
			this.devMode = (H5C3.DISTRO==="Developer"||H5C3.DISTRO==="Production") ? true : false;
			this.ready = true;
		}
	},
        ...
        if (this.$loc === 'local.html') {
			...
			if ($VLD(window.H5C3CFG)) {
				if (window.H5C3CFG.plugins.length > 0) {
					this.loadPlugins(window.H5C3CFG.plugins, '../../../../h5c3/plugins/');
				}
				if (window.H5C3CFG.files.length > 0) {
    ...
    _checkAllDone: function () {
        if (!this.$finished) {
            if (this.$scripts.length - 1 === this.$current) {
                this.$finished = true;
				if ($VLD(window.H5C3CFG)) this.finalize();
            } else {
                this.$current++;
                this._loadNextScript();
            }
...
_H5C3_CONFIG = {
	...
	app: {
		name:'H5C3 Engine API',
		version:'0.0.1', 
		publisher:'i2tm Labs',
		copyright:'2013 i2tm Labs - All rights reserved.'
	},
 ...
 * Class:	h5c3.HTMLVariables
 * 
 * This class allow you to access and change any part of an HTML document. It does not use the data properties of HTML5; to
 * keep maximum compatability it is accomplish by adding a class calledc variable to any element and this will give you access to that said element.
 *
 * >	<div id="someDiv class="variable"></div>
 *
 * then, in your application you can
 * 
 * >	//Array of all variables in document
 * >	var allVars = h5c3.vars.list();
 * >
 * >	// Get the value of variable title int he document
 * >	var title =h5c3.vars.get(title);
 *
 */
window.h5c3.HTMLVariables = h5c3.Base.extend('h5c3.HTMLVariables', 
	{ _HTMLVariables: 'HTMLVariables',_CLASSVERSION:'0.0.1'}, {
    /**
     * Property: h5c3.Hashtable	resources
     */
    vars: h5c3.plugin = new h5c3.Hashtable(),
	 ...
	 * Method: index()
	 *
	 * Scans HTML document for all elements with a class name of .Variable and sves them in the HashTable
     * 
	 * Parameters:
	 * None
	 *
     ...
     * 
	 * Parameters:
	 * String	$name	The element you want to have returned.
	 *
	 * Returns: 
	 * String	Element	
     */	
	 ...
	 *
	 * public method for adding data/content to a HTML Element
     * 
	 * Parameters:
	 * String	$name	The element you want to have returned.
	 * String	$value	The content to append or replace the in the element.
	 *
	 * Returns: 
	 * None
     */	
...
{},
{
	 ...
	 * 	Function 	onLoadCallback		Function to be called once the image has been loaded
	 * 	Function 	onErrorCallback		Function to be called if the image fails to load
	 *
	 * Returns:
	 * None
	 */
 ...
 *  h5c3.Base
 */
window.h5c3.Google = h5c3.Base.extend('h5c3.Google', {}, {
	/**
	 ...
	 *  H5C3
	 */
	NAME: 'H5C3 Framework Google Interface',
	/**
